    ...
    <main className="">
      ...
      <div className="overflow-hidden">
        ...
        >
          ...
          <div className="md:absolute z-10 bg-midgray h-7/10 w-7/8 transform translate-x-32 -translate-y-16 sm:translate-y-0 md:translate-y-44 lg:translate-y-28 cursor-default">
            <span
